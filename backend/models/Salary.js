...
// ===============================
// ✅ GET ALL SALARY (with teacher name)
// ===============================
export const getAllSalaryModel = (callback) => {
  const sql = `
...
// ✅ GET SALARY BY ID
// ===============================
export const getSalaryByIdModel = (id, callback) => {
  const sql = "SELECT * FROM salary WHERE id = ?";
  db.query(sql, [id], callback);
};

// ===============================
// ✅ GET SALARY BY TEACHER ID (with teacher name)
// ===============================
export const getSalaryByTeacherIdModel = (teacher_id, callback) => {
  const sql = `
    SELECT s.*, t.name AS teacher_name
    FROM salary s
    JOIN teachers t ON s.teacher_id = t.id
